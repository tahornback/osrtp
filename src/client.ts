...
export interface AveragedPrice {
  avgHighPrice: number;
...
export interface AveragedPrices {
...
const USER_AGENT = "osrtp-frontend - https://github.com/thornback/osrtp";
